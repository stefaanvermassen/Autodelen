...
CREATE TABLE `Cars` (
	...
	`car_fuel_economy` INT UNSIGNED,
	`car_estimated_value` INT UNSIGNED,
	`car_owner_annual_km` INT UNSIGNED,
	`car_owner_user_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE `CarInsurances` (
	...
	`insurance_contract_id` INT UNSIGNED NOT NULL DEFAULT '0', # Polisnr
	`insurance_bonus_malus` INT SIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `TechnicalCarDetails` (
	`details_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
	`car_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE `CarReservations` (
	...
	`reservation_car_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE `Infosessions` (
	`infosession_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
	`infosession_timestamp` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00',
	`infosession_address_id` INT UNSIGNED NOT NULL,
	`infosession_host_user_id` INT UNSIGNED,
...
CREATE TABLE `InfosessionEnrollees` ( # Wie is ingeschreven?
	`infosession_id` INT UNSIGNED NOT NULL,
	`infosession_enrollee_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE `CarPrivileges` (
	`car_privilege_user_id` INT UNSIGNED NOT NULL,
	`car_privilege_car_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE `CarCosts` (
	`car_cost_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
	`car_cost_car_id` INT UNSIGNED NOT NULL,
	`car_cost_proof` INT UNSIGNED,
...
CREATE TABLE `CarRides` (
	`car_ride_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
	`car_ride_car_id` INT UNSIGNED NOT NULL,
	`car_ride_user_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE `Messages` (
	...
	`message_from_user_id` INT UNSIGNED NOT NULL,
	`message_to_user_id` INT UNSIGNED NOT NULL,
