...
CREATE TABLE `CarReservations` (
	...
	`reservation_status` ENUM('REQUEST','ACCEPTED', 'REFUSED', 'CANCELLED', 'REQUEST_DETAILS', 'FINISHED') NOT NULL DEFAULT 'REQUEST', # Reeds goedgekeurd?
...
CREATE TABLE `CarRides` (
	...
	`car_ride_status` ENUM('REQUEST_INFO', 'INFO_PROVIDED', 'INFO_APPROVED') NOT NULL DEFAULT 'REQUEST_INFO',
